...
function fullName(){
 ...
 let lastName = prompt(`Enter a second name:`);
...
function addTwoNumbers() {
  let firstNum = Number(prompt(`Enter a first Number`));
  let  secondNum = Number(prompt(`Enter a Second Number`));
